...
const contract = require("../artifacts/contracts/EggTeam.sol/EggTeam.json");
const contractAddress = "0xD158e22236505308eB50a2b2790A956e7c8bB453";
...
export const mintNFT = async (mintAmount) => {
  ...
  const transactionParameters = {
    ...
    gasLimit: "0",
    data: nftContract.methods.mintEgg(mintAmount).encodeABI(), //make call to NFT smart contract
  };
